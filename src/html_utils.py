...
# Placeholder for actual config
# TODO: make these arguments to the functions
HTML_BASED_CONNECTOR_TRANSFORM_LINKS_STRATEGY = "strip"
PARSE_WITH_TRAFILATURA = (
    os.environ.get("PARSE_WITH_TRAFILATURA", "True").lower() == "true"
)
...
def format_element_text(element_text: str, link_href: str | None) -> str:
    ...
    if not link_href or HTML_BASED_CONNECTOR_TRANSFORM_LINKS_STRATEGY == "strip":
